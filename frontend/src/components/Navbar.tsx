...
export default function Navbar() {
  ...
  <a href="#/" className="flex items-center gap-2 hover:opacity-90 transition-opacity duration-200">
    ...
    <div>
      <span className="text-2xl font-bold bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">Book</span>
      <span className="text-xl font-medium text-gray-300 ml-1">Holiday Rentals</span>
    </div>
  </a>
</div>

      <div className="flex items-center gap-6">
        <a className="hidden md:inline-flex items-center px-3 py-2 rounded-lg hover:bg-white/10 transition-all duration-200 font-medium text-gray-200 hover:text-white" href="#/">
          Home
        </a>
        <a className="hidden md:inline-flex items-center px-3 py-2 rounded-lg hover:bg-white/10 transition-all duration-200 font-medium text-gray-200 hover:text-white" href="#/host">
          Host with us
        </a>
        ...
        {!user && (
          <>
            ...
            <a className="px-6 py-2 rounded-lg font-medium bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105" href="#/signup">
              Sign up
            </a>
          </>
        )}
